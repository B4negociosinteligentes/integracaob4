...
1- Faça o upload do arquivo a ser assinado usando a [API de Upload (POST /api/uploads)](https://assinador.somosb4.com.br/swagger/index.html). 
...
Alternativamente pode ser utilizada a [API simplificada de Upload (POST /api/uploads/bytes)](https://assinador.somosb4.com.br/swagger/index.html),
na qual os bytes podem ser enviados em formato Base64.

2- Crie um documento à partir do upload usando a [API de Criação de Documentos](https://assinador.somosb4.com.br/swagger/index.html). 
...
Após a criação do documento, utilize o ID do documento para obter a URL de Assinatura usando a [API de URL de Ação](https://assinador.somosb4.com.br/swagger/index.html):
...
* [Referência da API](https://assinador.somosb4.com.br/swagger/index.html)
* [Exemplos no GitHub](https://github.com/B4negociosinteligentes/docs)
